...
public class wrongHeightError_Frame extends JFrame implements ActionListener{
//list of all components of the frame
	private JPanel contentPane;
	private static wrongHeightError_Frame room_frame;
...
//creates the room_frame gets title from the room is meant for
	public wrongHeightError_Frame(String title) {
//sets up the frame
		...
		JLabel lblBlankRoomName = new JLabel("Invalid Height");
