...
public class TWP_Glider3_Frame extends JFrame implements ActionListener{
	...
	//creates the frame
		public TWP_Glider3_Frame(int index, Holder holder) {
	...
	//sets up the frame
		...
		private void calcTotalCost() {
			totalCost = energyCost +glassTypeCost +glassStrengthCost +spaceCost +screenCost +meshCost +winColorCost +winTintCost +reinforcementCost +mullCost +lockColorCost +tiltMiniblindsCost +frameColorCost +woodgrainCost +foamCost +orielCost +wrapCost +lamCost +sash1Cost +sash2Cost ;
		...
		protected JComponent makeWindowPanel() {
	        ...
	        panelList.setBounds(88, 33, 139, 28);
