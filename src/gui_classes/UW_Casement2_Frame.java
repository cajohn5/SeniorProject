...
public class UW_Casement2_Frame extends JFrame implements ActionListener{
...
//creates the frame
	public UW_Casement2_Frame(int index, Holder holder) {
...
//This is the panel of the home tab
	protected JComponent makeWindowPanel() {
		 JPanel panel = new JPanel();
	        ...
	        trimGroove1Label.setBounds(397, 114, 57, 14);
	        panel_2.add(trimGroove1Label);
	        
	    	JCheckBox chckbxTrimGroove = new JCheckBox(obj.getCustomExtrasList().get(1));	        chckbxTrimGroove.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxTrimGroove.setBounds(-2, 108, 393, 23);
	        panel_2.add(chckbxTrimGroove);
	        
	    	JCheckBox chckbxTrimGroove_2 = new JCheckBox(obj.getCustomExtrasList().get(3));	        chckbxTrimGroove_2.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxTrimGroove_2.setBounds(-2, 161, 393, 23);
	        panel_2.add(chckbxTrimGroove_2);
	        
	    	JCheckBox chckbxTrimGroove_1 = new JCheckBox(obj.getCustomExtrasList().get(2));	        chckbxTrimGroove_1.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxTrimGroove_1.setBounds(-2, 134, 393, 23);
	        panel_2.add(chckbxTrimGroove_1);
	        
	        JLabel trimGroove3Label = new JLabel();
	        trimGroove3Label.setFont(new Font("Tahoma", Font.PLAIN, 11));
	        trimGroove3Label.setBounds(397, 167, 57, 14);
	        panel_2.add(trimGroove3Label);
	        
	        JLabel trimGroove2Label = new JLabel();
	        trimGroove2Label.setFont(new Font("Tahoma", Font.PLAIN, 11));
	        trimGroove2Label.setBounds(397, 140, 53, 14);
	        ...
	        chckbxWindowOpeningControl.setBounds(-2, 33, 393, 23);
	        ...
	        chckbxPolyfoamWrap.setBounds(-2, 59, 393, 23);
	        ...
	        chckbxLaminated.setBounds(-2, 82, 393, 23);
