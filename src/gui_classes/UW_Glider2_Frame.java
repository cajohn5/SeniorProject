...
public class UW_Glider2_Frame extends JFrame implements ActionListener{
...
//creates the frame
	public UW_Glider2_Frame(int index, Holder holder) {
...
//This is the panel of the home tab
	protected JComponent makeWindowPanel() {
		 JPanel panel = new JPanel();
	        ...
	        JLabel lblGridOptionsSash_1 = new JLabel("End Sashes");
	        ...
	        JLabel orielsLabel = new JLabel("+$0.00");
	        ...
	        UILabel.setBounds(465, 20, 474, 30);
	        panel.add(UILabel);
