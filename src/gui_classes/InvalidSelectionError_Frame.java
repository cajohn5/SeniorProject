...
public class InvalidSelectionError_Frame extends JFrame implements ActionListener{
//list of all components of the frame
	private JPanel contentPane;
	private static InvalidSelectionError_Frame room_frame;
...
//creates the room_frame gets title from the room is meant for
	public InvalidSelectionError_Frame(String title) {
//sets up the frame
		...
		label = new JLabel("Selection not implemented.");
		label.setBounds(0, 39, 221, 25);
