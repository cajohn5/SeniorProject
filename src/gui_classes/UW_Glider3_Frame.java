...
public class UW_Glider3_Frame extends JFrame implements ActionListener{
...
//		}
	...
	//creates the frame
		public UW_Glider3_Frame(int index, Holder holder) {
	...
	//sets up the frame
		...
		private void calcTotalCost() {
			totalCost = energyCost +glassTypeCost +glassStrengthCost +spaceCost +screenCost +meshCost +winColorCost +winTintCost +reinforcementCost +mullCost +lockColorCost +tiltMiniblindsCost +frameColorCost +woodgrainCost +foamCost +orielCost +wrapCost +lamCost +trimGroove1Cost +trimGroove2Cost +trimGroove3Cost +sash1Cost +sash2Cost ;
		...
		protected JComponent makeWindowPanel() {
	        ...
	        JLabel lblGridOptionsSash = new JLabel("Center Sash");
	        ...
	        JLabel lblGridOptionsSash_1 = new JLabel("Ends Sashes");
	        ...
	        JCheckBox chckbxNewCheckBox = new JCheckBox("Same for both Sashes");
	        chckbxNewCheckBox.setFont(new Font("Tahoma", Font.BOLD, 11));
	        chckbxNewCheckBox.setBounds(10, 62, 162, 23);
	        ...
	        panel_7.setBounds(457, 168, 480, 301);
	        panel.add(panel_7);
	        panel_7.setLayout(null);
	        
	        JPanel panel_2 = new JPanel();
	        panel_2.setBounds(6, 16, 464, 272);
	        panel_7.add(panel_2);
	        panel_2.setLayout(null);
	        
	        JCheckBox chckbxPolyfoamWrap = new JCheckBox(obj.getCustomExtrasList().get(6));
	        chckbxPolyfoamWrap.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxPolyfoamWrap.setBounds(-2, 60, 393, 23);
	        ...
	        lamLabel.setBounds(397, 89, 57, 14);
	        ...
	        trimGroove1Label.setBounds(397, 115, 53, 14);
	        ...
	        trimGroove2Label.setBounds(397, 142, 53, 14);
	        ...
	        trimGroove3Label.setBounds(397, 165, 57, 14);
	        panel_2.add(trimGroove3Label);
	        
	        JCheckBox chckbxTrimGroove_2 = new JCheckBox(obj.getCustomExtrasList().get(4));
	        chckbxTrimGroove_2.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxTrimGroove_2.setBounds(-2, 159, 393, 23);
	        panel_2.add(chckbxTrimGroove_2);
	        
	        JCheckBox chckbxTrimGroove_1 = new JCheckBox(obj.getCustomExtrasList().get(3));
	        chckbxTrimGroove_1.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxTrimGroove_1.setBounds(-2, 136, 393, 23);
	        panel_2.add(chckbxTrimGroove_1);
	        
	        JCheckBox chckbxTrimGroove = new JCheckBox(obj.getCustomExtrasList().get(2));
	        chckbxTrimGroove.setFont(new Font("Dialog", Font.PLAIN, 14));
	        chckbxTrimGroove.setBounds(-2, 109, 393, 23);
	        ...
	        panel_10.setBorder(new TitledBorder(null, "Panel", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	        panel_10.setBounds(457, 62, 480, 98);
	        panel.add(panel_10);
	        panel_10.setLayout(null);
	        	        
	        JLabel lblNewLabel = new JLabel(obj.getPanelLabel());
	        lblNewLabel.setFont(new Font("Dialog", Font.PLAIN, 14));
	        lblNewLabel.setBounds(10, 26, 80, 35);
	        panel_10.add(lblNewLabel);
	        
	        JComboBox panelList = new JComboBox(new Vector(obj.getPanelList()));
	        panelList.setSelectedIndex(0);
	        panelList.setBounds(135, 30, 139, 28);
	        panel_10.add(panelList);
	        ...
	        UILabel.setBounds(464, 20, 475, 31);
	        panel.add(UILabel);
	        ...
	        panelList.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		if (panelList.getSelectedIndex() == 0){
		        		...
		        		label_28.setText(obj.getWidthLabel());		        		
		        		label_29.setText(obj.getHeightLabel());
		        		
	        		} else if (panelList.getSelectedIndex() == 1){
	        			//update width/height labels
		        		label_28.setText(obj.getWidth2Label());		        		
		        		label_29.setText(obj.getHeight2Label());
	        ...
	        chckbxTrimGroove.addItemListener(new ItemListener() {
	        	public void itemStateChanged(ItemEvent arg0) {
	        		if(chckbxTrimGroove.isSelected() && status.toLowerCase().equals(good)){
	        			trimGroove1Cost=obj.getCustomExtrasPrice(2, ui);
	        ...
	        chckbxTrimGroove_1.addItemListener(new ItemListener() {
	        	public void itemStateChanged(ItemEvent arg0) {
	        		if(chckbxTrimGroove_1.isSelected() && status.toLowerCase().equals(good)){
	        			trimGroove2Cost=obj.getCustomExtrasPrice(3, ui);
	        ...
	        chckbxTrimGroove_2.addItemListener(new ItemListener() {
	        	public void itemStateChanged(ItemEvent arg0) {
	        		if(chckbxTrimGroove_2.isSelected() && status.toLowerCase().equals(good)){
	        			trimGroove3Cost=obj.getCustomExtrasPrice(4, ui);
