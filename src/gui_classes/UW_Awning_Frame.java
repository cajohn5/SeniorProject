...
public class UW_Awning_Frame extends JFrame implements ActionListener{
...
//creates the frame
	public UW_Awning_Frame(int index) {
...
//sets up the frame
	...
	private void calcTotalCost() {
		totalCost = energyCost +glassTypeCost +glassStrengthCost +spaceCost +screenCost +meshCost +winColorCost +winTintCost +mullCost +lockColorCost +tiltMiniblindsCost +frameColorCost +woodgrainCost +foamCost +wrapCost +lamCost +trimGroove1Cost +trimGroove2Cost +trimGroove3Cost +sash1Cost +sash2Cost ;
...
//This is the panel of the home tab
	protected JComponent makeWindowPanel() {
        ...
        chckbxPolyfoamWrap.setBounds(0, 125, 390, 23);
        ...
        chckbxFoamFilledMain.setBounds(0, 7, 390, 23);
        ...
        chckbxTrimGroove.setBounds(0, 31, 390, 23);
        panel_2.add(chckbxTrimGroove);
        
        JLabel trimGroove2Label = new JLabel("+$0.00");
        trimGroove2Label.setFont(new Font("Tahoma", Font.PLAIN, 11));
        trimGroove2Label.setBounds(396, 62, 58, 14);
        ...
        chckbxTrimGroove_1.setBounds(0, 54, 390, 23);
        panel_2.add(chckbxTrimGroove_1);
        
        JLabel trimGroove3Label = new JLabel("+$0.00");
        trimGroove3Label.setFont(new Font("Tahoma", Font.PLAIN, 11));
        trimGroove3Label.setBounds(396, 87, 58, 14);
        ...
        chckbxTrimGroove_2.setBounds(0, 79, 390, 23);
        ...
        panel_5.setBounds(5, 203, 437, 106);
        panel_3.add(panel_5);
        ...
        lockColorList.setBounds(184, 84, 79, 20);
        panel_5.add(lockColorList);
        
        JCheckBox chckbxExtraLock = new JCheckBox("Extra Lock");
        chckbxExtraLock.setBounds(269, 82, 97, 23);
        panel_5.add(chckbxExtraLock);
        chckbxExtraLock.setFont(new Font("Dialog", Font.PLAIN, 14));
        
        JLabel lockColorCostLabel = new JLabel("+$0.00");
        lockColorCostLabel.setBounds(372, 82, 53, 14);
        panel_5.add(lockColorCostLabel);
        ...
        JLabel screenMeshCostLabel = new JLabel("+$0.00");
        ...
        panel_8.setBounds(5, 320, 437, 115);
        panel_3.add(panel_8);
        panel_8.setLayout(null);
        
        JLabel tiltMiniblindsCostLabel = new JLabel("+$0.00");
        tiltMiniblindsCostLabel.setFont(new Font("Tahoma", Font.PLAIN, 11));
        tiltMiniblindsCostLabel.setBounds(372, 0, 53, 14);
        ...
        woodgrainLabel.setBounds(0, 55, 174, 20);
