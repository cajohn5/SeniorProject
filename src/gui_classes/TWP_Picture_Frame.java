...
public class TWP_Picture_Frame extends JFrame implements ActionListener{
//list of all components of the frame
	...
	//creates the frame
	public TWP_Picture_Frame(int index, Holder holder) {
	...
	private void calcTotalCost() {
		totalCost = energyCost +glassTypeCost +glassStrengthCost +spaceCost  
				+winColorCost +winTintCost +mullCost +lockColorCost +tiltMiniblindsCost 
				+frameColorCost +woodgrainCost +foamCost +wrapCost +lamCost +sash1Cost 
				+sash2Cost ;
	...
	protected JComponent makeWindowPanel() {
		 JPanel panel = new JPanel();
	        ...
	        tiltMiniblindsCostLabel.setBounds(350, 0, 53, 14);
	        ...
	        tiltMiniblindsLabel.setBounds(0, 0, 152, 20);
	        ...
	        tiltMiniblindsList.setBounds(162, 0, 170, 20);
	        ...
	        frameColorLabel.setBounds(0, 31, 152, 20);
	        ...
	        woodgrainLabel.setBounds(0, 58, 152, 20);
	        ...
	        woodgrainList.setBounds(162, 58, 170, 20);
	        ...
	        chckbxPolyfoamWrap.addItemListener(new ItemListener() {
	        	public void itemStateChanged(ItemEvent arg0) {
	        		if(chckbxPolyfoamWrap.isSelected() && status.toLowerCase().equals(good)){
	        			wrapCost=obj.getCustomExtrasPrice(1, ui);
	        ...
	        chckbxLaminated.addItemListener(new ItemListener() {
	        	public void itemStateChanged(ItemEvent arg0) {
	        		if(chckbxLaminated.isSelected() && status.toLowerCase().equals(good)){
	        			lamCost=obj.getCustomExtrasPrice(2, ui);
