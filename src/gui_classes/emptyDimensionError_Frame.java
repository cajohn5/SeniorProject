...
public class emptyDimensionError_Frame extends JFrame implements ActionListener{
//list of all components of the frame
	private JPanel contentPane;
	private static emptyDimensionError_Frame room_frame;
...
//creates the room_frame gets title from the room is meant for
	public emptyDimensionError_Frame(String title) {
//sets up the frame
		...
		JLabel lblBlankRoomName = new JLabel("Dimensions Cannot Be 0");
