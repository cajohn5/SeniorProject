...
/**
 * Reads the (UW) Vinyl Single Casement sheet, parses the necessary
...
public class ExcelReadUW_1Case
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(UW) Vinyl Single Casement";
		...
		public ArrayList<String> testObject()
			{
				return WINDOW_obj.getLockColorList();
			}
	}
