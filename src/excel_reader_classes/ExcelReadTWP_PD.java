...
/**
 * Reads the (TWP) Patio Door sheet, parses the necessary
...
public class ExcelReadTWP_PD
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(TWP) Patio Door";
		...
		public ArrayList<String> testObject()
			{
				return WINDOW_obj.getFrameColorNum().get(0);
			}
	}
