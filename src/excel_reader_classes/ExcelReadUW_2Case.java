...
/**
 * Reads the (UW) Vinyl Double Casement sheet, parses the necessary
...
public class ExcelReadUW_2Case
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(UW) Vinyl Double Casement";
		...
		private void parsePanels()
    		{
    			...
    			WINDOW_obj.setPanelLabel(temp.get(0));
    			
    			//values
    			ArrayList<ArrayList<String>> temp2 = readStringGroup(getRowIndex() + 1,0);
    			WINDOW_obj.setPanelNum(temp2);
    		}
		...
		private void parsedGridOptions()
			{
				...
				//options row
				temp.remove(0);
				WINDOW_obj.setGridOptions(temp);
		 ...
		 * @return
		 */
		public ArrayList<ArrayList<String>> testObject()
			{
				return WINDOW_obj.getMiniblindsNum();
			}
	}
