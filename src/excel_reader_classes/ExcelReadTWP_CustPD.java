...
/**
 * Reads the (TWP) Custom Patio Door sheet, parses the necessary
...
public class ExcelReadTWP_CustPD
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(TWP) Custom Patio Door";
		 ...
		 * 
		 */
		private void parsedHandleColor()
			{
				//first row
				ArrayList<String> temp = readOneRow(getRowIndex());
