...
/**
 * Reads the (DW) Patio Door sheet, parses the necessary
...
public class ExcelReadDW_PD
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(DW) Patio Door";
		 ...
		 * 
		 */
		private void parsedHardwareColor()
			{
				//first row
				ArrayList<String> temp = readOneRow(getRowIndex());
		...
		public ArrayList<String> testObject()
			{
				return WINDOW_obj.getGridOptionsList();
			}
	}
