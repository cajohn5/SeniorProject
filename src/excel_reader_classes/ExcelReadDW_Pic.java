...
/**
 * Reads the (DW) Picture sheet, parses the necessary
...
public class ExcelReadDW_Pic
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(DW) Picture";
		...
		private void parsedGlassStrength()
			{
				...
				//string matrix (2-D array)
				WINDOW_obj.setGlassStrengthNum(readStringGroup(getRowIndex() + 1,1));
			}
		...
		private void parsedSpacer()
    		{
    			//first row
				ArrayList<String> temp = readOneRow(46);
				...
				//list
				ArrayList<String> temp2 = new ArrayList<String>();
				temp2 = readOptionsList(47);
				WINDOW_obj.setSpacerList(temp2);
				
				//string matrix (2-D array)
				WINDOW_obj.setSpacerNum(readStringGroup(47,1));
    		}
		...
		private void parsedMull()
    		{
    			//first row
				ArrayList<String> temp = readOneRow(50);
				...
				//list
				ArrayList<String> temp2 = new ArrayList<String>();
				temp2 = readOptionsList(51);
				WINDOW_obj.setMullList(temp2);
				
				//string matrix (2-D array)
				WINDOW_obj.setMullNum(readStringGroup(51,1));
    		}
		...
		private void parsedGlassTint()
    		{
    			//first row
				ArrayList<String> temp = readOneRow(55);
				...
				//list
				ArrayList<String> temp2 = new ArrayList<String>();
				temp2 = readOptionsList(56);
				WINDOW_obj.setGlassTintList(temp2);
				
				//string matrix (2-D array)
				WINDOW_obj.setGlassTintNum(readStringGroup(56,1));
    		}
		...
		private void parsedCustomExtras()
    		{
    			//first row
				ArrayList<String> temp = readOneRow(60);
				...
				//list
				ArrayList<String> temp2 = new ArrayList<String>();
				temp2 = readOptionsList(61);
				WINDOW_obj.setCustomExtrasList(temp2);
				
				//string matrix (2-D array)
				WINDOW_obj.setCustomExtrasNum(readStringGroup(61,1));
    		}		
		...
		public ArrayList<String> testObject()
			{
				return WINDOW_obj.getGlassStrengthList();
			}
