...
/**
 * Reads the (DW) 3-LiteGlider sheet, parses the necessary
...
public class ExcelReadDW_3Glide
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(DW) 3-LiteGlider";
		...
		private void parsePanels()
    		{
    			//label
    			ArrayList<String> temp = readOneRow(14);
    			WINDOW_obj.setPanelLabel(temp.get(0));
    			
    			//values
    			temp.remove(0);
    			WINDOW_obj.setPanelList(temp);
