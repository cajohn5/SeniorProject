...
/**
 * Reads the (TWP) Double Hung sheet, parses the necessary
 ...
 *
 */
public class ExcelReadTWP_DH
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(TWP) Double Hung";
		...
		private void setRowIndex (int rowIndex)
			{
				ExcelReadTWP_DH.rowIndex = rowIndex;
			}
