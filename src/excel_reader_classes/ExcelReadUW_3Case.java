...
/**
 * Reads the (UW) Vinyl Triple Casement sheet, parses the necessary
...
public class ExcelReadUW_3Case
	{
		private Windows WINDOW_obj = new Windows();
		private int sheetIndex;
		private String sheetName = "(UW) Vinyl Triple Casement";
		...
		private void parsePanels()
    		{
    			...
    			//options (merged)
    			WINDOW_obj.setPanelList(readMergedRow());
		...
		public ArrayList<String> testObject()
			{
				return WINDOW_obj.getSpacerList();
			}
	}
